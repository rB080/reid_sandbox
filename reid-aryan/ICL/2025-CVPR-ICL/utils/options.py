...
def get_args():
    ...
    parser.add_argument("--wandb_project", default="ICL-2025-CVPR-ICL")
    parser.add_argument("--wandb_run_id", default="run_id", help="wandb run id, if not set, will be auto generated")
