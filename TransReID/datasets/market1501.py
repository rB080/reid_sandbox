...
class Market1501(BaseImageDataset):
    ...
    def __init__(self, root='', verbose=True, pid_begin = 0, **kwargs):
        ...
        self.train = self.remove_camid(self.train, [0, 1, 3, 4, 5], keep_only=True, unique_pids=True)
        self.query = self.remove_camid(self.query, [2], keep_only=True)
        self.gallery = self.remove_camid(self.gallery, [0, 1, 3, 4, 5], keep_only=True)
