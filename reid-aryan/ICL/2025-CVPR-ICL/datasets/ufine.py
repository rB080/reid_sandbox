...
class UFine6926(BaseDataset):
    ...
    def __init__(self, root='', verbose=True):
        ...
        self.anno_path = op.join(self.dataset_dir, 'UFine6926_Annotations_1024.json')
        self.anno_path = '/home/qinyang/projects/ACVPR/RDE_bak/data/data_1110/r_ufine_1110_dec_1110.json'
    ...
    def _process_anno(self, annos: List[dict], training=False):
        ...
        if training:
            ...
            for anno in annos:
                pid = int(anno['id'])
                pid_container.add(pid-1) # start from 0
                ...
                for i, caption in enumerate(captions):
                    # dataset.append((pid, image_id, img_path, caption, caption))
            ...
            for anno in annos:
                ...
                # caption_list = anno['mllm_captions'] # caption list
                # diversity_captions_list =  anno['diversity_captions'] 
                diversity_captions_list =  anno['val_diversity_captions'] 
                for i, caption in enumerate(caption_list):
                    # caption =  anno['coarse_captions'][i]
                    captions.append(caption)
                    dec_captions.append(diversity_captions_list[i]) 
                    # dec_captions.append(caption)
