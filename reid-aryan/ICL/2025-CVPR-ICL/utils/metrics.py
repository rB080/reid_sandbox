...
class Evaluator():
    ...
    def _compute_embedding(self, model):
        ...
        # text
        for pid, caption, _ in self.txt_loader:
        ...
        return F.normalize(qfeats.cpu(), p=2, dim=1) , F.normalize(gfeats.cpu(), p=2, dim=1), qids.cpu(), gids.cpu()
